...
# PostgreSQL - Production (high pool size)
...
# Phoenix PubSub with Redis - Production
config :quckapp_realtime, QuckAppRealtime.PubSub,
  ...
  password: System.get_env("REDIS_PASSWORD"),
  ssl: System.get_env("REDIS_SSL") == "true",
  node_name: System.get_env("NODE_NAME") || "realtime-production"
...
config :quckapp_realtime, :kafka,
  ...
  consumer_group: "realtime-service-production",
